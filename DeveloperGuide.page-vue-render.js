...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As an …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("internship applicant")]),_v(" "),_c('td',[_v("see usage instructions")]),_v(" "),_c('td',[_v("refer to instructions when I forget how to use the App")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("internship applicant")]),_v(" "),_c('td',[_v("assign tags to contacts")]),_v(" "),_c('td',[_v("categorize and easily identify and prepare for the interview")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("internship applicant")]),_v(" "),_c('td',[_v("customize tag colors")]),_v(" "),_c('td',[_v("visually differentiate between different stages")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("internship applicant")]),_v(" "),_c('td',[_v("sort contacts by dates")]),_v(" "),_c('td',[_v("prioritize and plan for upcoming interviews")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("internship applicant")]),_v(" "),_c('td',[_v("filter contacts by date")]),_v(" "),_c('td',[_v("quickly access contacts associated with a specific date")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("internship applicant")]),_v(" "),_c('td',[_v("filter contacts by tag")]),_v(" "),_c('td',[_v("easily find and manage contacts within specific categories")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("internship applicant")]),_v(" "),_c('td',[_v("add a time to a contact")]),_v(" "),_c('td',[_v("record when a specific task or interaction needs to be done")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("internship applicant")]),_v(" "),_c('td',[_v("add notes to contacts")]),_v(" "),_c('td',[_v("include important details or information about specific users")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Internship Applicant inputs contact information of internship company.")]),_v(" "),_c('li',[_v("IH stores the contact information.")]),_v(" "),_c('li',[_v("Use case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. IH detects an error in the entered data.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. IH requests for the correct data.")]),_v(" "),_c('li',[_v("1a2. Internship Applicant enters new data.")]),_v(" "),_c('li',[_v("Steps 1a1-1a2 are repeated until the data entered are correct.")]),_v(" "),_c('li',[_v("Use case resumes from step 2.")])])]),_v(" "),_c('li',[_c('p',[_v("*a. At any time, Internship Applicant chooses to cancel the input.")]),_v(" "),_c('ul',[_c('li',[_v("Use case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Internship Applicant inputs index of contact to be deleted.")]),_v(" "),_c('li',[_v("IH deletes the relevant contact information.")]),_v(" "),_c('li',[_v("Use case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. IH detects an error in index of contact")]),_v(" "),_c('ul',[_c('li',[_v("1a1. IH requests for proper input of index (1 to current number of contacts)")]),_v(" "),_c('li',[_v("1a2. Internship Applicant enters the correct index.")]),_v(" "),_c('li',[_v("Steps 1a1-1a2 are repeated until the selection is correct.")]),_v(" "),_c('li',[_v("Use case resumes from step 2.")])])]),_v(" "),_c('li',[_c('p',[_v("*a. At any time, the Internship Applicant chooses to cancel to detect contact.")]),_v(" "),_c('ul',[_c('li',[_v("*a1. IH cancels deletion of contact.")]),_v(" "),_c('li',[_v("Use case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Internship Applicant chooses contact to edit by its index and enters relevant fields to be modified")]),_v(" "),_c('li',[_v("IH modifies that corresponding field of that contact")]),_v(" "),_c('li',[_v("Use case ends")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. IH detects an error in index of contact")]),_v(" "),_c('ul',[_c('li',[_v("1a1. IH requests for proper input of index (1 to current number of contacts)")]),_v(" "),_c('li',[_v("1a2. Internship Applicant enters the correct index.")]),_v(" "),_c('li',[_v("Steps 1a1-1a2 are repeated until the selection is correct.")]),_v(" "),_c('li',[_v("Use case resumes from step 2.")])])]),_v(" "),_c('li',[_c('p',[_v("1a. IH detects an error in the fields to be edited (No fields at all or incorrect field prefixes)")]),_v(" "),_c('ul',[_c('li',[_v("1a1. IH requests for proper input of fields and correct prefix")]),_v(" "),_c('li',[_v("1a2. Internship Applicant enters the fields to be edited.")]),_v(" "),_c('li',[_v("Steps 1a1-1a2 are repeated until the selection is correct.")]),_v(" "),_c('li',[_v("Use case resumes from step 2.")])])]),_v(" "),_c('li',[_c('p',[_v("*a. At any time, the Internship Applicant chooses to cancel to edit contact.")]),_v(" "),_c('ul',[_c('li',[_v("*a1. IH cancels edit of contact.")]),_v(" "),_c('li',[_v("Use case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Internship Applicant chooses to filter contacts by tag.")]),_v(" "),_c('li',[_v("Internship Applicant inputs the tag.")]),_v(" "),_c('li',[_v("IH filters the contacts associated with the selected tag.")]),_v(" "),_c('li',[_v("IH displays the filtered contacts.")]),_v(" "),_c('li',[_v("Use case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. IH detects an error in tag to be filtered")]),_v(" "),_c('ul',[_c('li',[_v("2a1. IH requests for proper input of tag (One of existing tags)")]),_v(" "),_c('li',[_v("2a2. Internship Applicant enters the correct tag.")]),_v(" "),_c('li',[_v("Steps 2a1-2a2 are repeated until the selection is correct.")]),_v(" "),_c('li',[_v("Use case resumes from step 3.")])])]),_v(" "),_c('li',[_c('p',[_v("*a. At any time, the Internship Applicant chooses to cancel the filtering.")]),_v(" "),_c('ul',[_c('li',[_v("*a1. System cancels the filtering.")]),_v(" "),_c('li',[_v("Use case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Internship Applicant chooses contact to be viewed on view panel.")]),_v(" "),_c('li',[_v("IH requests for the specific contact index.")]),_v(" "),_c('li',[_v("Internship Applicant enters the contact index.")]),_v(" "),_c('li',[_v("IH views the relevant contact on the view panel.")]),_v(" "),_c('li',[_v("Use case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("3a. IH detects an error in index of contact")]),_v(" "),_c('ul',[_c('li',[_v("3a1. IH requests for proper input of index (1 to current number of contacts)")]),_v(" "),_c('li',[_v("3a2. Internship Applicant enters the correct index.")]),_v(" "),_c('li',[_v("Steps 3a1-3a2 are repeated until the selection is correct.")]),_v(" "),_c('li',[_v("Use case resumes from step 3.")])])]),_v(" "),_c('li',[_c('p',[_v("*a. At any time, Internship Applicant chooses to cancel to view contact.")]),_v(" "),_c('ul',[_c('li',[_v("*a1. IH cancels viewing of contact.")]),_v(" "),_c('li',[_v("Use case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.3.0")]),_v(", generated on Fri, 1 Mar 2024, 16:56:23 GMT+8]")])])])}
}];
